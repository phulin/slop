...
- For a better sparsity/reconstruction tradeoff: use the 1M-cache `4096/k512/lr5e-3/wsd/e96` run as the next production candidate, but treat the gain over e64 as marginal.
