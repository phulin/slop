...
- For weakly sparse reconstruction: continue from the 1M-cache `2048/k768/lr1e-3/e16` region.
- For a better sparsity/reconstruction tradeoff: use the 1M-cache `2048/k512/lr1e-3/wsd/e16` run as the next production candidate.
