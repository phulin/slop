...
Top 1M-cache k512/WSD AI-target latent effects:
...
- For a better sparsity/reconstruction tradeoff: use the 1M-cache `2048/k512/lr1e-3/wsd/e8` run as the next production candidate.
