...
rates: eleven pretraining-collection source samples, one SmolTalk2 Mid sample,
...
- Ran it with source maps
  ...
  `smollm3_pretrain_fw2_cmn_2k=fw2-cmn`, and
  `smollm3_pretrain_fw2_rus_2k=fw2-rus`. The current retained Tier-1 proxy
  covers `78.955%` of the extracted recipe and leaves `21.045%` unsampled.
- Covered-only weighted rates per 1k tokens are: `slop_lexicon` `0.395`,
  `rule_of_three_approx` `4.304`, `contrastive_negation` `0.382`,
  `stock_closers` `0.035`, `stock_openers` `0.028`, and pooled stock phrases
  `0.064`. These are coverage-normalized diagnostics, not full-mixture
...
| Feature | Weighted proxy covered-only | FineWeb-Edu | DCLM | FineWeb2 German | FineWeb2 Spanish | FineWeb2 French | FineWeb2 Italian | FineWeb2 Chinese | FineWeb2 Russian | FineMath | PES2O | StackExchange | Mid | SFT target | Chosen | Rejected | Chosen - Rejected | Pair BH q |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `contrastive_negation` | 0.382 | 0.385 | 0.487 | 0.006 | 0.002 | 0.002 | 0.003 | 0.004 | 0.003 | 0.181 | 0.238 | 0.509 | 0.177 | 0.095 | 0.379 | 0.352 | +0.027 | 0.039 |
| `rule_of_three_approx` | 4.304 | 6.211 | 3.746 | 0.184 | 0.038 | 0.100 | 0.066 | 0.152 | 0.052 | 1.817 | 5.520 | 1.583 | 1.273 | 17.045 | 5.443 | 4.877 | +0.566 | 9.437e-13 |
| `slop_lexicon` | 0.395 | 0.536 | 0.354 | 0.047 | 0.005 | 0.088 | 0.036 | 0.022 | 0.005 | 0.150 | 0.716 | 0.327 | 0.050 | 0.419 | 1.609 | 1.293 | +0.316 | 3.367e-15 |
| `stock_closers` | 0.035 | 0.042 | 0.037 | 0.002 | 0.000 | 0.001 | 0.000 | 0.000 | 0.000 | 0.036 | 0.060 | 0.026 | 0.027 | 0.270 | 0.217 | 0.167 | +0.050 | 3.016e-04 |
| `stock_openers` | 0.028 | 0.027 | 0.037 | 0.000 | 0.000 | 0.000 | 0.000 | 0.007 | 0.000 | 0.065 | 0.000 | 0.069 | 0.000 | 0.106 | 0.571 | 0.334 | +0.237 | 0.161 |
| `stock_openers_closers` | 0.064 | 0.068 | 0.074 | 0.002 | 0.000 | 0.001 | 0.000 | 0.007 | 0.000 | 0.100 | 0.060 | 0.095 | 0.027 | 0.376 | 0.788 | 0.502 | +0.287 | 0.003 |
...
coverage-aware weighted proxy over eleven mapped recipe source samples. It is
...
3. Expand SmolLM3 pretraining feature-rate coverage beyond the current
   `78.955%` retained Tier-1 recipe share covered by DCLM, FineWeb-Edu,
   FineWeb2 German, FineWeb2 Spanish, FineWeb2 French, FineWeb2 Italian,
   FineWeb2 Chinese, FineWeb2 Russian, FineMath, PES2O, and StackExchange.
   ...
   sampleable high-impact sources are FineWeb2 Portuguese (`0.931%`),
